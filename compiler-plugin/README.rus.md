        ...
        <configuration>
            ...
            <passes>
                <pass>
                    ...
                    <entryFile>${basedir}/src/main/webapp/desktop.entry.js</entryFile>
                    <outputFile>${project.build.directory}/${project.build.finalName}/desktop.js</outputFile>
                </pass>
                <pass>
                    <entryFile>${basedir}/src/main/webapp/mobile.entry.js</entryFile>
...
<tr>
  ...
  <td></td>
  <td>+</td>
  <td>Путь до дочки входа, например <code>${basedir}/src/main/webapp/desktop.entry.js</code></td>
</tr>
<tr>
  <td>outputFile</td>
  <td>string (path)</td>
